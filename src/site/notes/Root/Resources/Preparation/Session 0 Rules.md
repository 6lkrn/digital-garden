---
{"dg-publish":true,"permalink":"/root/resources/preparation/session-0-rules/"}
---
...
**Backgrounds, [[Campaign Resources/Rules/One Piece 5e/DM Screen/General Rules/5E General Rules/Feats\|Campaign Resources/Rules/One Piece 5e/DM Screen/General Rules/5E General Rules/Feats]] & Mounts**
...
-   **Additional mechanic rules** - If you have additional rules that focus on general game play that isn't covered by another topic in this article, list them here. You may want to consider additionally discussing; what is involved in Taming [[Creatures\|Creatures]]; how much damage you get from Lava/Magma; the breakdown of how Dark-vision, [[Campaign Resources/Magic/Spells/Darkness\|Campaign Resources/Magic/Spells/Darkness]], & Dim light work, in addition to your other house-rules.
...
-   **[[Traps\|Traps]]** - Do you as a DM use the new Unearthed Arcana rule-set for [[[[Traps\|[[Traps\|Traps]]|[[tra\|tra]]ps]]? Are [[Traps\|Traps]] a heavy feature in your game? How often can adventurers be expected to encounter a trap? Do overcoming/defeating [[Traps]] provide EXP? If so, how much EXP can players expect?
    

**[[NPCS\|NPCS]]/[[Creatures\|Creatures]]**
...
-   **[[Attunement\|Attunement]]/Identify** - Does [[Attunement\|Attunement]] reveal everything about an item, or do PCs need to identify them to get the full list of everything an item can do? Do PCs need to identify an item before being able to attune to it?
